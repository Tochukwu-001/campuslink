...
import { HiOutlineBookmark, HiOutlineShare, HiOutlineFilter, HiOutlineSearch } from "react-icons/hi";
...
const feedItems = [
  {
    ...
    newsUpdate: "Just uploaded a comprehensive breakdown of alternative visual proofs for real analysis and integration steps. Perfect if the standard textbook explanations aren't clicking!",
  ...
  },
  {
    ...
    newsUpdate: "The academic board has pushed back the second-semester examination kick-off date by two weeks. Updated PDFs for all departments are now downloadable in the resources tab.",
  ...
  },
  {
    ...
    newsUpdate: "We're hosting a live roundtable chat this Friday discussing structural adjustments to study groups. Learn how to delegate teaching topics to improve group grade averages.",
    timestamp: "Yesterday",
    author: "Prof. Collins",
            ...
            <div className="pt-4 border-t border-slate-50 flex items-center justify-between text-slate-400 text-sm">
              ...
              <div className="flex items-center gap-4">
                <button 
                  ...
                  style={{ '--hover-color': theme.secondaryColor } as React.CSSProperties}
                >
